...
//== operator checks if the 1 value is equals to other value if yes then it returns boolean true
...
// && logical operator and means the both statements shoudl be true
console.log(
  "Is person subject == 'Metaverse' && Is subject's subject1 == 'Metaverse' ? I predict True."
);
...
//&& and || or used or means one statement of any should be true and and means everystatement should be true
console.log(
  "Is person name == 'Muhammad Sarim' && Is person age == 20 && is person subject =='Metaverse' && Is vehicle name = 'Corolla' && Is subject subject1 == 'metaverse'||Is Subject duration = '3 months' i predict true"
);
console.log(
  (person.name == "Muhammad Sarim" &&
    person.age == 20 &&
    person.subject == "Metaverse" &&
    vehicle.name == "corolla" &&
    subject.subject1 == "Metaverse") ||
